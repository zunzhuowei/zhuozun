...
public interface GameManager {
    ...
    default Pool getInitKunPool() {
        if (Objects.isNull(POOL.getPoolCells()) || POOL.getPoolCells().isEmpty()) {
            ...
            cells.add(new PoolCell().setNo(3).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(4).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(5).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(6).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(7).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(8).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(9).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(10).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
            cells.add(new PoolCell().setNo(11).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
//            cells.add(new PoolCell().setNo(12).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
//            cells.add(new PoolCell().setNo(13).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
//            cells.add(new PoolCell().setNo(14).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
//            cells.add(new PoolCell().setNo(15).setKuns(new Kuns().setWork(0).setTime(0).setType(KunType.TYPE_1)));
