...
public class MemcachedController extends BaseController {
    ...
    public BaseResult saveGoodsBrand(@RequestBody ProductRequest productRequest) throws InterruptedException, MemcachedException, TimeoutException {
        ...
        boolean b = memcachedClient.set(PRODUCT_CENTER_GET_GOODS_BRAND_BY_ID.KEY + id, IntConst.MONTH,
                JSON.toJSONString(productRequest.getGoodsBrand()));
